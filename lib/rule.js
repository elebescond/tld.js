...
/**
 * The rule is a regular one (not an exception neither a wildcard)
 * @type {number}
 */
Rule.TYPE_REGULAR = 0;

/**
 * The rule is an exception rule.
 * @type {number}
 */
Rule.TYPE_EXCEPTION = 1;

/**
 * The rule is a wildcard rule.
 * @type {number}
 */
Rule.TYPE_WILDCARD = 2;

/**
 * Returns the actual bitwise Type based on internal attributes.
 *
 * @returns {number} Bitwise flag
 */
Rule.prototype.getFlag = function(){
  return Rule.TYPE_REGULAR | (this.exception && Rule.TYPE_EXCEPTION) | (this.wildcard && Rule.TYPE_WILDCARD);
};
